...
const Footer = () => {
    ...
    return ( 
        <>
        <footer className="py-5 mt-5 bg-brand">
        ...
        <div className='py-5 px-7 mt-5'>
            <div className="flex flex-col md:flex-row items-center md:justify-between space-y-4 text-center md:text-left">
                <div className="flex flex-col justify-center items-center md:hidden">
                    <p className='text-xs'>Sykes Seafood Address:</p>
                    <address className='text-xs font-thin text-footer'>
                        <p className='text-xs flex'>100 King Street</p> 
                        <p className='text-xs'>Knutsford</p>
                        <p className='text-xs'>Cheshire</p> 
                        <p className='text-xs'>WA16 6HQ</p>
                    </address>
                    <p className='text-xs'>Registration Number 02289318</p>
                </div>
                <div className="flex flex-col">
                    <address className='text-xs font-thin text-footer text-left hidden md:block'>
